...
<xsl:stylesheet version="2.0" 
  ...
  <xsl:key name="group1" match="Table" use="RefCategories_Categories_Name"/>
  <xsl:template name="replace" match="text()" mode="replace">
    ...
    <xsl:template match="Table">
		<xsl:if test="//NewDataSet/Table1/sorting_topics = '1'">
        <Row ss:AutoFitHeight="0" ss:Height="18.75" ss:StyleID="s65">
            <Cell ss:MergeAcross="13" ss:StyleID="m43389152"><Data ss:Type="String">
                <xsl:value-of select="RefCategories_Categories_Name"/>
                <xsl:choose>
                    <xsl:when test = "RefCategories_Categories_Name = '4.01. Об обеспечении полисами ОМС.'"> (Всего элементов: <xsl:value-of select="count(//Table[RefCategories_Categories_Name='4.01. Об обеспечении полисами ОМС.'])"/>)
                    </xsl:when>
                    <xsl:when test = "RefCategories_Categories_Name = '4.02. Выбор ЛПУ в системе ОМС'"> (Всего элементов: <xsl:value-of select="count(//Table[RefCategories_Categories_Name='4.02. Выбор ЛПУ в системе ОМС'])"/>)
                    </xsl:when>
                    <xsl:when test = "RefCategories_Categories_Name = '4.03. Выбор врача'"> (Всего элементов: <xsl:value-of select="count(//Table[RefCategories_Categories_Name='4.03. Выбор врача'])"/>)
                    </xsl:when>
                    <xsl:when test = "RefCategories_Categories_Name = '4.04. Выбор СМО'"> (Всего элементов: <xsl:value-of select="count(//Table[RefCategories_Categories_Name='4.04. Выбор СМО'])"/>)
                    </xsl:when>
                    <xsl:when test = "RefCategories_Categories_Name = '4.05. Организация работы ЛПУ'"> (Всего элементов: <xsl:value-of select="count(//Table[RefCategories_Categories_Name='4.05. Организация работы ЛПУ'])"/>)
                    </xsl:when>
                    <xsl:when test = "RefCategories_Categories_Name = '4.06. Санитарно -гигиеническое состояние ЛПУ'"> (Всего элементов: <xsl:value-of select="count(//Table[RefCategories_Categories_Name='4.06. Санитарно -гигиеническое состояние ЛПУ'])"/>)
                    </xsl:when>
                    <xsl:when test = "RefCategories_Categories_Name = '4.07. Этика и деонтология мед. работников'"> (Всего элементов: <xsl:value-of select="count(//Table[RefCategories_Categories_Name='4.07. Этика и деонтология мед. работников'])"/>)
                    </xsl:when>
                    <xsl:when test = "RefCategories_Categories_Name = '4.08. КМП'"> (Всего элементов: <xsl:value-of select="count(//Table[RefCategories_Categories_Name='4.08. КМП'])"/>)
                    </xsl:when>
                    <xsl:when test = "RefCategories_Categories_Name = '4.09. Лекарственное обеспечение'"> (Всего элементов: <xsl:value-of select="count(//Table[RefCategories_Categories_Name='4.09. Лекарственное обеспечение'])"/>)
                    </xsl:when>
                    <xsl:when test = "RefCategories_Categories_Name = '4.10. Отказ в медицинской помощи'"> (Всего элементов: <xsl:value-of select="count(//Table[RefCategories_Categories_Name='4.10. Отказ в медицинской помощи'])"/>)
                    </xsl:when>
                    <xsl:when test = "RefCategories_Categories_Name = '4.11. Получение мед. помощи по базовой программе ОМС вне территории страхования'"> (Всего элементов: <xsl:value-of select="count(//Table[RefCategories_Categories_Name='4.11. Получение мед. помощи по базовой программе ОМС вне территории страхования'])"/>)
                    </xsl:when>
                    <xsl:when test = "RefCategories_Categories_Name = '4.12. Взимание денежных средств за медицинскую помощь по программе ОМС'"> (Всего элементов: <xsl:value-of select="count(//Table[RefCategories_Categories_Name='4.12. Взимание денежных средств за медицинскую помощь по программе ОМС'])"/>)
                    </xsl:when>
                    <xsl:when test = "RefCategories_Categories_Name = '4.13. Платные медицинские услуги, оказываемые в МО'"> (Всего элементов: <xsl:value-of select="count(//Table[RefCategories_Categories_Name='4.13. Платные медицинские услуги, оказываемые в МО'])"/>)
                    </xsl:when>
                    <xsl:when test = "RefCategories_Categories_Name = '4.14. Другие'"> (Всего элементов: <xsl:value-of select="count(//Table[RefCategories_Categories_Name='4.14. Другие'])"/>)
                    </xsl:when>
					<xsl:when test = "RefCategories_Categories_Name = '4.01.1. Об обеспечении полисами ОМС иностранных граждан, беженцев'"> (Всего элементов: <xsl:value-of select="count(//Table[RefCategories_Categories_Name='4.01.1. Об обеспечении полисами ОМС иностранных граждан, беженцев'])"/>)
                    </xsl:when>
					<xsl:when test = "RefCategories_Categories_Name = '4.12.1. О видах, кач-ве и условиях предосавления мед. помощи по программе ОМС'"> (Всего элементов: <xsl:value-of select="count(//Table[RefCategories_Categories_Name='4.12.1. О видах, кач-ве и условиях предосавления мед. помощи по программе ОМС'])"/>)
                    </xsl:when>
                    <xsl:otherwise>
    ...
    <xsl:template match="NewDataSet">
        ...
        <Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
            ...
            <Worksheet ss:Name="Отчет по заявкам">
                <Table ss:ExpandedColumnCount="14"  x:FullColumns="1"   x:FullRows="1" ss:DefaultRowHeight="15">
   ...
   <Column ss:AutoFitWidth="0" ss:Width="560.25"/>
                    ...
                    <xsl:apply-templates select="Table[generate-id(.) = generate-id(key('group1',RefCategories_Categories_Name))]" />
